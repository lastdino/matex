...
<div class="p-6 space-y-6">
    ...
    <div class="grid gap-6 md:grid-cols-2">
        ...
        <div class="rounded border p-4 space-y-4">
            <div class="flex items-center justify-between">
                <flux:heading size="sm">{{ __('procflow::settings.options.items.heading') }} @if($this->selectedGroup) <span class="text-gray-500 text-xs">({{ __('procflow::settings.options.items.group_hint', ['name' => $this->selectedGroup->name]) }})</span> @endif</flux:heading>
