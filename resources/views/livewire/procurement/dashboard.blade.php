...
<div class="p-6 space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-6 gap-4">
        <flux:card class="flex flex-col justify-between">
            <div>
                <flux:heading size="sm" level="3" class="text-neutral-500">{{ __('procflow::dashboard.cards.open_pos') }}</flux:heading>
        ...
        <flux:card class="flex flex-col justify-between">
            <div>
                <flux:heading size="sm" level="3" class="text-neutral-500">{{ __('procflow::dashboard.cards.this_month_total') }}</flux:heading>
        ...
        <flux:card class="flex flex-col justify-between">
            <div>
                <flux:heading size="sm" level="3" class="text-neutral-500">{{ __('procflow::dashboard.cards.low_stock_materials') }}</flux:heading>
                <div class="text-3xl font-semibold mt-2">{{ $this->lowStocks->count() }}</div>
                <div class="mt-1">
                    <flux:badge color="red" size="sm" inset="top bottom">{{ __('procflow::dashboard.cards.critical') }}: {{ $this->lowStockCriticalCount }}</flux:badge>
                </div>
            </div>
        </flux:card>
        ...
        <flux:card class="flex flex-col justify-between">
            <div>
                <flux:heading size="sm" level="3" class="text-neutral-500">{{ __('procflow::dashboard.cards.overdue_pos') }}</flux:heading>
        ...
        <flux:card class="flex flex-col justify-between">
            <div>
                <flux:heading size="sm" level="3" class="text-neutral-500">{{ __('procflow::dashboard.cards.incoming_7d') }}</flux:heading>
        ...
        <flux:card class="flex flex-col justify-between">
            <div>
                <flux:heading size="sm" level="3" class="text-neutral-500">{{ __('procflow::dashboard.cards.otif_30d') }}</flux:heading>
    ...
    <flux:card>
        <flux:heading size="lg" level="2" class="mb-4">{{ __('procflow::dashboard.low_stock.title') }}</flux:heading>

        <flux:table>
            <flux:table.columns>
                <flux:table.column>{{ __('procflow::dashboard.low_stock.table.sku') }}</flux:table.column>
                <flux:table.column>{{ __('procflow::dashboard.low_stock.table.name') }}</flux:table.column>
                <flux:table.column>{{ __('procflow::dashboard.low_stock.table.stock') }}</flux:table.column>
                <flux:table.column>{{ __('procflow::dashboard.low_stock.table.min_qty') }}</flux:table.column>
            </flux:table.columns>
            ...
            <flux:table.rows>
                ...
                @empty
                    <flux:table.row>
                        <flux:table.cell colspan="4" class="text-center text-neutral-500 py-4">{{ __('procflow::dashboard.low_stock.empty') }}</flux:table.cell>
                    </flux:table.row>
                @endforelse
            </flux:table.rows>
        </flux:table>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <flux:card>
            <flux:heading size="lg" level="2" class="mb-4">{{ __('procflow::dashboard.top_suppliers.title') }}</flux:heading>
        ...
        <flux:card>
            <flux:heading size="lg" level="2" class="mb-4">{{ __('procflow::dashboard.spend_trend.title') }}</flux:heading>
